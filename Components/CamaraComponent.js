...
import { Container, Content, Header, Body, Icon, Item, Input } from 'native-base';
import { Camera, Permissions } from 'expo';
import MaterialCommunityIcons from 'react-native-vector-icons/MaterialCommunityIcons'
export default class CamaraComponent extends Component {
  ...
  async componentWillMount() {
    ...
    this.setState({ hasCameraPermission: status === 'granted' });//estado del permiso de la camera
  }
  render() {
    const { hasCameraPermission } = this.state;
    if (hasCameraPermission === null) {
      return <View ><Text>Permissions null</Text></View>;
